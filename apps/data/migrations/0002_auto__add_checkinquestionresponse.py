...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CheckinQuestionResponse'
        db.create_table(u'data_checkinquestionresponse', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checkinquestionresponse_created', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checkinquestionresponse_updated', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('checkin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Checkin'])),
        ...
        db.send_create_signal(u'data', ['CheckinQuestionResponse'])


    def backwards(self, orm):
        # Deleting model 'CheckinQuestionResponse'
        db.delete_table(u'data_checkinquestionresponse')
